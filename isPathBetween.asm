boolean isPathBetween(int x1, int y1, int x2, int y2) {
    ...
    if(abs(xDiff) < abs(yDiff)) {
        ...
        yStep = yDiff / absXDiff
        ySubStep = yDiff % absXDiff
        ...
        for(v0 = 0; v0 < absXDiff; v0++) {
            ...
            tileId = y1 * 100 + x1
            tileValue = load(0x001BF398 + tileId) & 0x80
        ...
        xStep = xDiff / absYDiff
        xSubStep = xDiff % absYDiff
